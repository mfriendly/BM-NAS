...
STEP_STEP_OPS = {  #셀안에 순서 의미하는 동그라미 노드 사이......(step간의 op)
...
class ScaledDotAttn(nn.Module):
    ...
    def __init__(self, C, L):
        ...
        self.ln = nn.LayerNorm([C, L])#: Given normalized_shape=[29, 16], expected input with shape [*, 29, 16], but got input of size[16, 32, 29]
