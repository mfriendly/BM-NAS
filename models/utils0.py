...
def parse_opts(args): ####################################
    ...
    parser.add_argument('--dataset', default='kinetics', type=str, help='Used dataset (activitynet | kinetics | ucmse01 | hmdb51)')
    parser.add_argument('--n_classes', default=400, type=int, help='Number of classes (activitynet: 200, kinetics: 400, ucmse01: 101, hmdb51: 51)')
    ...
    parser.add_argument('--batch_size', default=29, type=int, help='Batch Size')###################128>29 CNN???????????????????
